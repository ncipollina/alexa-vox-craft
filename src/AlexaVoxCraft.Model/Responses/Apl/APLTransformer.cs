...
public class APLTransformer
{
    ...
    [JsonPropertyName("inputPath"), JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public string InputPath { get; set; }

    [JsonPropertyName("outputName"), JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public string OutputName { get; set; }

    [JsonPropertyName("transformer")] public string Transformer { get; set; }
