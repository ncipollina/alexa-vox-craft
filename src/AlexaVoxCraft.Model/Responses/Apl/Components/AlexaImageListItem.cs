...
public class AlexaImageListItem : AlexaPaginatedListItem
{
    ...
    [JsonPropertyName("imageHideScim"), JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    ...
    [JsonPropertyName("providerText"), JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public APLValue<string> ProviderText { get; set; }

    [JsonPropertyName("hasPlayIcon"), JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    ...
    [JsonPropertyName("contentDirection"), JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
