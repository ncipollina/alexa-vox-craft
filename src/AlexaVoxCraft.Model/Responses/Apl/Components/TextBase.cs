...
public abstract class TextBase : APLComponent
{
    ...
    [JsonPropertyName("letterSpacing"), JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public APLDimensionValue LetterSpacing { get; set; }
    [JsonPropertyName("lineHeight"), JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public APLValue<double?> LineHeight { get; set; }
    [JsonPropertyName("maxLines"), JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public APLValue<int?> MaxLines { get; set; }
    [JsonPropertyName("textAlign"), JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public APLValue<string> TextAlign { get; set; }
    [JsonPropertyName("textAlignVertical"), JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public APLValue<string> TextAlignVertical { get; set; }
    [JsonPropertyName("overflow"), JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public APLValue<TextOverflow?> TextOverflow { get; set; }
    [JsonPropertyName("msPerCharacter"), JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
