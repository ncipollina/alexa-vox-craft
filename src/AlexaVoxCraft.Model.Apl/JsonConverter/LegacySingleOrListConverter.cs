...
public abstract class LegacySingleOrListConverter<TValue> : Newtonsoft.Json.JsonConverter
{
    public bool AlwaysOutputArray { get; }

    protected LegacySingleOrListConverter() : base() { }

    protected LegacySingleOrListConverter(bool alwaysOutputArray)
    {
